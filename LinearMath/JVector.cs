...
namespace Jitter.LinearMath
{
    ...
    public struct JVector
    {
        ...
        private static JFix64 ZeroEpsilonSq = JFix64Math.Epsilon * JFix64Math.Epsilon;
        ...
        /// (JFix64.MinValue,JFix64.MinValue,JFix64.MinValue);
        /// </summary>
        public static readonly JVector MinValue;
        /// <summary>
        /// A vector with components 
        /// (JFix64.MaxValue,JFix64.MaxValue,JFix64.MaxValue);
        /// </summary>
        ...
        static JVector()
        {
            One = new JVector(JFix64.One, JFix64.One, JFix64.One);
            Zero = new JVector(JFix64.Zero, JFix64.Zero, JFix64.Zero);
            Left = new JVector(JFix64.One, JFix64.Zero, JFix64.Zero);
            Right = new JVector(-JFix64.One, JFix64.Zero, JFix64.Zero);
            Up = new JVector(JFix64.Zero, JFix64.One, JFix64.Zero);
            Down = new JVector(JFix64.Zero, -JFix64.One, JFix64.Zero);
            Backward = new JVector(JFix64.Zero, JFix64.Zero, JFix64.One);
            Forward = new JVector(JFix64.Zero, JFix64.Zero, -JFix64.One);
            MinValue = new JVector(JFix64.MinValue);
            MaxValue = new JVector(JFix64.MaxValue);
            Arbitrary = new JVector(JFix64.One, JFix64.One, JFix64.One);
            InternalZero = Zero;
        }
        #endregion
        ...
        public JVector(JFix64 x, JFix64 y, JFix64 z)
        {
            this.X = x;
            this.Y = y;
            this.Z = z;
        ...
        /// <param name="y">The Y component of the vector.</param>
        /// <param name="z">The Z component of the vector.</param>
        public void Set(JFix64 x, JFix64 y, JFix64 z)
        {
            this.X = x;
            this.Y = y;
            this.Z = z;
        ...
        public bool IsZero()
        {
            return (this.LengthSquared() == JFix64.Zero);
        }
        ...
        {
            JFix64 num0 = ((position.X * matrix.M11) + (position.Y * matrix.M21)) + (position.Z * matrix.M31);
            JFix64 num1 = ((position.X * matrix.M12) + (position.Y * matrix.M22)) + (position.Z * matrix.M32);
            JFix64 num2 = ((position.X * matrix.M13) + (position.Y * matrix.M23)) + (position.Z * matrix.M33);
        ...
        {
            JFix64 num0 = ((position.X * matrix.M11) + (position.Y * matrix.M12)) + (position.Z * matrix.M13);
            JFix64 num1 = ((position.X * matrix.M21) + (position.Y * matrix.M22)) + (position.Z * matrix.M23);
            JFix64 num2 = ((position.X * matrix.M31) + (position.Y * matrix.M32)) + (position.Z * matrix.M33);
        ...
        #region public static JFix64 Dot(JVector vector1, JVector vector2)
        public static JFix64 Dot(JVector vector1, JVector vector2)
        {
        ...
        /// <param name="vector2">The second vector.</param>
        /// <returns>Returns the dot product of both vectors.</returns>
        public static JFix64 Dot(ref JVector vector1, ref JVector vector2)
        {
        ...
        {
            JFix64 num0 = value1.X + value2.X;
            JFix64 num1 = value1.Y + value2.Y;
            JFix64 num2 = value1.Z + value2.Z;
        ...
        {
            JFix64 num3 = (vector1.Y * vector2.Z) - (vector1.Z * vector2.Y);
            JFix64 num2 = (vector1.Z * vector2.X) - (vector1.X * vector2.Z);
            JFix64 num = (vector1.X * vector2.Y) - (vector1.Y * vector2.X);
            result.X = num3;
            result.Y = num2;
            result.Z = num;
        }
        ...
        {
            JFix64 num2 = ((this.X * this.X) + (this.Y * this.Y)) + (this.Z * this.Z);
        ...
        {
            JFix64 num2 = ((value.X * value.X) + (value.Y * value.Y)) + (value.Z * value.Z);
            JFix64 num = JFix64.One / (JFix64Math.Sqrt(num2));
        ...
        #region public JFix64 LengthSquared()
        public JFix64 LengthSquared()
        {
        ...
        #region public JFix64 Length()
        public JFix64 Length()
        {
            JFix64 num = ((this.X * this.X) + (this.Y * this.Y)) + (this.Z * this.Z);
            return JFix64Math.Sqrt(num);
        }
        #endregion
        ...
        #region public static JVector Multiply(JVector value1, JFix64 scaleFactor)
        public static JVector Multiply(JVector value1, JFix64 scaleFactor)
        {
            JVector result;
        ...
        public static void Multiply(ref JVector value1, JFix64 scaleFactor, out JVector result)
        {
        ...
        #region public static JFix64 operator *(JVector value1, JVector value2)
        public static JFix64 operator *(JVector value1, JVector value2)
        {
        ...
        #region public static JVector operator *(JVector value1, JFix64 value2)
        public static JVector operator *(JVector value1, JFix64 value2)
        {
            JVector result;
        ...
        /// <returns>Returns the scaled vector.</returns>
        #region public static JVector operator *(JFix64 value1, JVector value2)
        public static JVector operator *(JFix64 value1, JVector value2)
        {
            JVector result;
