...
namespace Jitter.LinearMath
{
    ...
    public partial struct JFix64 : IEquatable<JFix64>, IComparable<JFix64>
    {
        ...
        public static JFix64 Sin(JFix64 x)
        {
            ...
            var nearestValue =
                new JFix64(SinLut[flipHorizontal ? SinLut.Length - 1 - (int)roundedIndex : (int)roundedIndex]);
    ...
    partial struct JFix64 {
        public static readonly long[] TanLut = new[] {");
                ...
                for (int i = 0; i < LUT_SIZE; ++i)
                {
                    ...
                    var rawValue = (((decimal)tan > (decimal)MaxValue || tan < 0.0) ? MaxValue : (JFix64)tan)
                        .SerializedValue;
                    writer.Write(string.Format("0x{0:X}L, ", rawValue));
                }
